...
* DTP Assistant/Trainer at Computer Reseller<!-- .element: class="fragment"-->
* Graphic Designer at Different Print Shops<!-- .element: class="fragment"-->
* Senior Interactive Designer at Tribune Interactive<!-- .element: class="fragment"-->
* Director of Multimedia at Entravision<!-- .element: class="fragment"-->
* Staff Author, Lynda.com/LinkedIn<!-- .element: class="fragment"-->

---

## How I got my start

* How I found computers - Indiana Jones &amp; Curiosity<!-- .element: class="fragment"-->
* Becoming a geek - Solving Problems<!-- .element: class="fragment"-->
* Failing at Basketball - Focus<!-- .element: class="fragment"-->
* Found my calling helping others<!-- .element: class="fragment"-->
* DTP Trainer - importance of learning<!-- .element: class="fragment"-->
---

## Importance of Volunteering<!-- .slide: class="title"-->

* Don't be afraid to volunteer<!-- .element: class="fragment"-->
* It IS your job<!-- .element: class="fragment"-->
* Don't be limited by scope<!-- .element: class="fragment"-->

---

## Career Path

* Designer at Print Shops (Deke, James)<!-- .element: class="fragment"-->
* Invested heavily in learning<!-- .element: class="fragment"-->
* Joined Meetups OAF/Ad2<!-- .element: class="fragment"-->
* Joined Tribune Interactive<!-- .element: class="fragment"-->
* Learned through Lynda.com<!-- .element: class="fragment"-->

---

## Flipping Opportunities

* Networking turns to a job<!-- .element: class="fragment"-->
* Training leads to a book deal<!-- .element: class="fragment"-->
* Becoming an Adjunct <!-- .element: class="fragment"-->
* Flipping classroom into LDC<!-- .element: class="fragment"-->
* LDC into speaking at Conferences<!-- .element: class="fragment"-->

---

## Getting Demoted/Promoted

- Promotion is not Pride<!-- .element: class="fragment"-->
- No one else is responsible<!-- .element: class="fragment"-->
- Opportunities will come to you<!-- .element: class="fragment"-->
- Doubling my Salary by being nice<!-- .element: class="fragment"-->
- Making Money At Conferences<!-- .element: class="fragment"-->

---

## Must Have Promotional Tools

- Gravatar<!-- .element: class="fragment"-->
- LinkedIn<!-- .element: class="fragment"-->
- Twitter<!-- .element: class="fragment"-->
- Twitter<!-- .element: class="fragment"-->
- Facebook<!-- .element: class="fragment"-->
- Porfolio/Blog/Website<!-- .element: class="fragment"-->

---

## Learning Today

- Books are still awesome<!-- .element: class="fragment"-->
- The Web is rich<!-- .element: class="fragment"-->
- Videos are fast<!-- .element: class="fragment"-->
- Network with locals at Meetups<!-- .element: class="fragment"-->
- Learn what's new @ conferences<!-- .element: class="fragment"-->
- Podcasts -- in touch with experts<!-- .element: class="fragment"-->
- Slack/IRC/Google Groups for direct contact<!-- .element: class="fragment"-->

---

## Getting Published

- Be authoritative<!-- .element: class="fragment"-->
- Find a unique angle<!-- .element: class="fragment"-->
- Stalking Contacts/LinkedIn/Twitter<!-- .element: class="fragment"-->
- Find them at Conferences<!-- .element: class="fragment"-->
- Offer to review books<!-- .element: class="fragment"-->
- Don't be afraid to Seek/Ask<!-- .element: class="fragment"-->

---

## Speaking at conferences
- Be famous<!-- .element: class="fragment"-->
- Be an authority<!-- .element: class="fragment"-->
- Be Unique<!-- .element: class="fragment"-->
- Be Awesome<!-- .element: class="fragment"-->
- Start locally<!-- .element: class="fragment"-->
- Do it for love<!-- .element: class="fragment"-->

				<section id="slide_home" data-state="home"> <!-- slide -->
